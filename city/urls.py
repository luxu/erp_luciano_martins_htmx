...
urlpatterns = [
    ...
    path("search/", views.CitySearchView, name="city_search", ),
    path("create/", views.CityCreateView.as_view(), name="city_create", ),
    path("<int:pk>/", views.CityDetailsView.as_view(), name='city_detail'),
    path("<int:pk>/edit/", views.CityEditView.as_view(), name="city_update", ),
